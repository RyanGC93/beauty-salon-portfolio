  ...
  return (
    <PageContainer>
      ...
      <Section>
        ...
        <Paragraph>
          Our mission is to deliver high-quality products and services that exceed our customers' expectations. We strive to innovate continuously and improve our processes to achieve excellence in everything we do. Our commitment to sustainability and community engagement is at the core of our values.
        </Paragraph>
      </Section>
    
      <FounderSection>
        <FounderImage src="https://images.unsplash.com/photo-1683792384287-d7233ac491d1?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OTl8fHByb2ZpbGUlMjBwaWN0dXJlfGVufDB8fDB8fHww" alt="Founder" />
        <FounderDetails>
          <FounderName>Jessica Smith, Founder</FounderName>
          <Paragraph>
            Jessica Smith, our founder, started this salon with a vision to create a luxurious and welcoming space where clients could feel pampered and valued. With over 20 years of experience in the beauty industry, Jessica's expertise and passion have been the driving force behind our salon's success. She believes in continuous learning and ensures that our team is always ahead of the curve with the latest beauty trends and techniques. Jessica's dedication to excellence and her genuine care for each client have made our salon a beloved destination for beauty enthusiasts.
          </Paragraph>
        </FounderDetails>
      </FounderSection>
    </PageContainer>
